...
export class SDKUtil {
    ...
    private generateIndexCode() {
        ...
        return [
            ...
            '        const { getAuthorizationCredential, onResponse, ignoreCache, prefix, ...requestOptions } = this?.options;',
            '        const finalCustomOptions = _.merge({}, { ignoreCache, prefix }, { ignoreCache: options?.ignoreCache, prefix: options?.prefix });',
